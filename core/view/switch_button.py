...
from qfluentwidgets.common.color import fallbackThemeColor, validColor
from qfluentwidgets.common.overload import singledispatchmethod
from qfluentwidgets.common.style_sheet import FluentStyleSheet, ThemeColor, isDarkTheme, setCustomStyleSheet
...
class Indicator(ToolButton):
    ...
    knobWidth = Property(float, getKnobWidth, setKnobWidth)
    knobHeight = Property(float, getKnobHeight, setKnobHeight)
    checkedProgress = Property(float, getCheckedProgress, setCheckedProgress)
...
class SwitchButton(QWidget):
    """ Switch button with drag toggle restored """
